...
void functionEnable::addFuncFF(VoidCallBackFunction func, int frequecy, int flags) {
...
void functionEnable::addFunc(VoidCallBackFunction func, int frequecy) {

	this->addFuncFF(func, frequecy, 0);  // always run every frequency

}


void functionEnable::addFunc(VoidCallBackFunction func, int frequecy, int flags) {
	// flags:
	// 0 = run again
	// 1 = run once (then remove)
	// 2 = remove next cycle
...
void functionEnable::remFunc(VoidCallBackFunction func) {
...
void functionEnable::execute(long funcMillis) {
