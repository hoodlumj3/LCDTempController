...
## Realisation
I'm guessing im not the first to do all this, but it's my journey. 

## Goal

To build a temperature controller for my cheap chinese 40w C02 laser cutter 
...
### References (information ive directly gained knowledge from)
...
### Mentionables (stuff I've come across (via Google) but not directly used but may have lead to other sources of info)
